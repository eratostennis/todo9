...
public class AsyncHttpRequestBtn extends AsyncTask<Uri.Builder, Void, String> {
    ...
    public AsyncHttpRequestBtn(Activity activity,OnClickListener onClickListener) {
        // 呼び出し元のアクティビティ
