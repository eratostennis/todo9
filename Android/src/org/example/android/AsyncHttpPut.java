...
public class AsyncHttpPut extends AsyncTask<Uri.Builder, Void, String> {
    String put_id;
    String put_body;
	String[] global_id;
	String[] global_body;
    ...
    public AsyncHttpPut(Activity activity,OnClickListener onClickListener, String edit_id,  String text) {
        // 呼び出し元のアクティビティ
